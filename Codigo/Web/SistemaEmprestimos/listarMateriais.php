...
<head>
    ...
    <title>Listar Materiais - Sistema Emprestimos</title>
</head>
<body>
            ...
            <div class="col bg-light vh-100 overflow-auto">
                <div class="navbar">
                    <form action="" method="POST">
                        <label class="mx-auto">Pesquisa:</label>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            if (!empty($_POST['nome'])) {
                                $nome = $_POST['nome'];
                                $sql = "SELECT * FROM materiais WHERE nome LIKE '%$nome%'";
                            }
                            else {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='3' class='text-center'>Sem resultados</td></tr>";
                            }
                            $conexao->close();
                        ?>
                    </tbody>
