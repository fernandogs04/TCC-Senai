 ...
 * @author Fernando
 */
public class AdminEditarUsuarioController implements Initializable {
    ...
    //Stage
    @FXML public static Stage StageAdminEditarUsuario;
    
    @FXML
    public void Voltar (ActionEvent event) throws Exception {
        StageAdminEditarUsuario.close();
    }
        ...
        if (tf_Nome.getText().isEmpty() || tf_CPF.getText().isEmpty() ||
            ...
            alert.showAndWait();
             ...
             try {
                ...
                usuario.setId_usuario(AdminBuscarUsuarioController.Usuario_Selecionado.getId_usuario());
                ...
                //O objeto usuario armazena os dados digitados pelo usuario na tela !
                
                DAO_Usuario dao = new DAO_Usuario();

                dao.Atualiza_Usuario(usuario);

                Alert alert = new Alert(Alert.AlertType.INFORMATION);

                alert.setTitle("Usuario Atualizado!");
                alert.setHeaderText("Usuario atualizado com sucesso!!");
                alert.showAndWait();
                ...
                System.out.println("Atualizar - " + ex.getMessage());
            }
        }
    }

    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("AdminEditarUsuario.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        tf_Nome.setText(AdminBuscarUsuarioController.Usuario_Selecionado.getNome());
        tf_CPF.setText(AdminBuscarUsuarioController.Usuario_Selecionado.getCpf());
        tf_Email.setText(AdminBuscarUsuarioController.Usuario_Selecionado.getEmail());
        cb_Funcionario.setSelected(AdminBuscarUsuarioController.Usuario_Selecionado.isFuncionario().equals("Sim"));
